...
exec "${PYTHON:-python}" -m scripts.run \
  ...
  --moe-ve-slot-map-path artifacts/slotmaps/t2_d24_dense_ve_6e19_20260425T075852Z_fixed_knn_table_slotmap_k4_step022412.json
